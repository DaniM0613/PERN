...
export default function ProductDetails({product} : ProductDetailsProps) {
  ...
  return (
    <tr className="border-b">
        ...
        <td className="pt-3 text-lg text-gray-800">
        ...
        <td className="p-3 text-lg text-gray-800">
          <div className="flex gap-2 items-center">
            <button
              ...
              className='bg-indigo-600 text-center text-white rounded-lg  w-full p-2 uppercase font-bold text-xs'
            >Editar</button> 
            ...
            >
               <input
                 type='submit'
                 value='Eliminar'
                 className='bg-red-600 text-center text-white rounded-lg w-full p-2 uppercase font-bold text-xs'
               />
            </Form>
